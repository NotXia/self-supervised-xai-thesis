...
\begin{equation}
    ...
    \begin{gathered}
        ...
        \end{aligned} \\
        \text{with } \gamma = \frac{1}{\texttt{clip}\{ \L_\text{task}(\x \otimes \S; f) - \L_\text{task}(\x; f), [0, 1] \}},
    \end{gathered}
\end{equation}
...
\begin{figure}[t!]
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[scale=0.65]{./img/arch-text1.pdf}
        \caption{}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[scale=0.65]{./img/arch-text2.pdf}
        \caption{}
    \end{subfigure}
